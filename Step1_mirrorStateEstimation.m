...
for ind = 1:numel(Files)
    ...
    [mp1f, mp2f, conts] = mirrorPointExtract(S1S, S2S, pst);
    ...
    pst.MP1 = mp1f; pst.MP2 = mp2f; % use the mirror state from full spectra as the see mirror state
    S1BS = []; S2BS = [];
    for frameIdx = 1:5:50
    ...
    [MP1, MP2, cond] = mirrorPointExtract(S1S, S2S, pst);
